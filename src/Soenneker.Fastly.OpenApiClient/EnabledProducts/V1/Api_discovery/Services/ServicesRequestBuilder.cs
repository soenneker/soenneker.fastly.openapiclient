...
namespace Soenneker.Fastly.OpenApiClient.EnabledProducts.V1.Api_discovery.Services
{
    ...
    public partial class ServicesRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <summary>
        /// Get all the services for a customer that has the API Discovery product enabled.&gt; **Authorization**: [API token](/reference/api/auth-tokens) with at least [Engineer](/guides/organizations-and-accounts/user-and-account-management/about-user-roles-and-permissions&quot;) permissions.
        /// </summary>
